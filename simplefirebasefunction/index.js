                               ...
                               // var bigimagess = eventSnapshot.child("bigimage").val()
                                ...
                                var payload = {
                                    data:{
                                        ...
                                        bigimage : eventSnapshot.child("bigimage").val()
                                    }
                                };
...
//  const firebaseObject = event.data.val();
  ...
  // var uid = event.auth.variable ? event.auth.variable.uid : null;
   ...
   var nodeName = fileName.split(".")[0];
   var nodeNames = nodeName.substring(0,nodeName.length-4);

    return ref.child('users').child(nodeNames).update({photoURL: thumbFileUrl});
